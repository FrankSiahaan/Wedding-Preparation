  ...
  <div class="w-full max-w-md">
    ...
    <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
      ...
      <div class="text-center mb-6">
        <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-yellow-50 ring-1 ring-yellow-100 mb-4">
      ...
      <button type="button" class="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors mb-6">
