            ...
            <nav class="flex items-center justify-end gap-4">
                @auth
                    <a href="{{ route('cart.index') }}"
                        class="inline-flex items-center justify-center w-8 h-8 rounded-full border border-[#19140035] dark:border-[#3E3E3A] text-[#1b1b18] dark:text-[#EDEDEC] hover:border-[#1915014a] dark:hover:border-[#62605b]">
                    ...
                    <a href="{{ route('user.profile') }}"
                        class="inline-flex items-center gap-1.5 pl-1.5 pr-2.5 py-1 rounded-full border border-[#19140035] dark:border-[#3E3E3A] hover:border-[#1915014a] dark:hover:border-[#62605b]">
                        <span
                            class="inline-flex items-center justify-center w-6.5 h-6.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A] text-[#1b1b18] dark:text-[#EDEDEC]">
                        ...
                        <span class="text-sm text-[#1b1b18] dark:text-[#EDEDEC]">{{ auth()->user()->name }}</span>
                    </a>
                @else
                    <a href="{{ route('login') }}"
