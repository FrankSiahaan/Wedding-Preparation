  ...
  <div class="w-full max-w-md">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8">
      ...
      <div class="text-center mb-8">
        <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-yellow-100 to-yellow-50 rounded-full mb-4">
          <svg class="w-10 h-10 text-yellow-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
            <path d="M12 21s-6.716-4.319-9.192-8.055C1.113 10.16 2.02 7.5 4.41 6.5 6.08 5.8 7.93 6.3 9 7.6c1.07-1.3 2.92-1.8 4.59-1.1 2.39 1 3.3 3.66 1.6 6.45C18.72 16.68 12 21 12 21Z" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>
      ...
      <form method="POST" action="#" class="space-y-5">
        ...
        <div>
          ...
          <input id="email" name="email" type="email" required placeholder="masukkan email anda"
                 class="mt-1 w-full rounded-lg border-gray-300 focus:border-pink-500 focus:ring-pink-500 text-sm" />
        ...
        <div>
          ...
          <div class="relative">
            <input id="password" name="password" type="password" required placeholder="masukkan password anda"
                   class="w-full rounded-lg border-gray-300 focus:border-pink-500 focus:ring-pink-500 text-sm pr-10" />
            <button type="button" id="togglePass" class="absolute inset-y-0 right-0 px-3 flex items-center text-gray-400 hover:text-gray-600"
          ...
          <div class="mt-2 text-right">
            <a href="#" class="text-sm text-blue-600 hover:text-blue-700">Lupa sandi?</a>
          </div>
        </div>
      ...
      <p class="text-center text-sm text-gray-600 mt-6">
        Belum punya akun?
        <a href="#" class="font-semibold text-blue-600 hover:text-blue-700">Daftar</a>
      </p>
    </div>
  </div>
