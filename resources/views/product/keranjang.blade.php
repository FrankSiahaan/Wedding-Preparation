      ...
      <nav class="flex items-center justify-between h-14">
        ...
        <div class="flex items-center gap-3">
          ...
          <button class="grid place-items-center w-8 h-8 rounded-full border border-gray-200 text-gray-700 hover:bg-gray-50 relative">
            ...
            <span class="absolute -top-1 -right-1 w-4 h-4 bg-pink-600 text-white text-[9px] font-bold rounded-full grid place-items-center">1</span>
          </button>
  ...
  <main class="container mx-auto px-4 max-w-6xl py-6">
    ...
    <div class="grid lg:grid-cols-[1fr_380px] gap-6 mb-8">
      ...
      <div class="bg-white rounded-lg border border-gray-100 p-5">
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="flex items-center gap-1.5">
            <input type="checkbox" id="selectAll" class="w-4 h-4 rounded border-gray-300 text-pink-600 focus:ring-pink-500">
        ...
        <div class="flex gap-3.5 pb-4 mb-4 border-b border-gray-100">
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="mb-2">
              <h3 class="text-sm font-semibold text-gray-900 mb-0.5 line-clamp-2">Gaun Pengantin Mewah Collection Premium</h3>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center gap-2">
                <button class="w-7 h-7 rounded border border-gray-300 hover:bg-gray-50 flex items-center justify-center text-gray-600">
                  <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"/>
                  </svg>
                </button>
                <input type="number" value="1" min="1" class="w-14 h-7 text-center border border-gray-300 rounded text-sm font-medium focus:outline-none focus:ring-1 focus:ring-pink-500">
                <button class="w-7 h-7 rounded border border-gray-300 hover:bg-gray-50 flex items-center justify-center text-gray-600">
                  <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {{-- Delete Button --}}
          <div class="flex items-center">
            <button class="w-8 h-8 rounded hover:bg-red-50 flex items-center justify-center text-gray-400 hover:text-red-600 transition-colors">
        ...
        <div class="flex gap-3.5 pb-4 border-b border-gray-100">
          ...
          <div class="flex-1 min-w-0">
            {{-- Product Title & Vendor --}}
            <div class="mb-2">
              <h3 class="text-sm font-semibold text-gray-900 mb-0.5 line-clamp-2">Cincin Kawin Emas 18K Premium</h3>
              <div class="flex items-center gap-1 text-xs text-gray-500">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/>
                </svg>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center gap-2">
                ...
                <input type="number" value="2" min="1" class="w-14 h-7 text-center border border-gray-300 rounded text-sm font-medium focus:outline-none focus:ring-1 focus:ring-pink-500">
                <button class="w-7 h-7 rounded border border-gray-300 hover:bg-gray-50 flex items-center justify-center text-gray-600">
                  <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                  </svg>
      ...
      <div class="bg-white rounded-lg border border-gray-100 p-4 h-fit sticky top-20">
        ...
        <div class="mb-4 pb-4 border-b border-gray-100">
          <button class="w-full flex items-center justify-between text-sm text-gray-700 hover:text-pink-600 transition-colors">
            <div class="flex items-center gap-1.5">
        ...
        {{-- Checkout Button --}}
        <button class="w-full bg-pink-600 hover:bg-pink-700 text-white font-semibold py-2.5 rounded-lg text-sm transition-colors shadow-sm">
          Lanjutkan ke Pembayaran
        </button>
        
        {{-- Additional Info --}}
        <div class="mt-3 flex items-start gap-1.5 text-xs text-gray-500">
          <svg class="w-3.5 h-3.5 mt-0.5 text-green-600 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-lg border border-gray-100 p-4">
      <div class="flex items-end justify-between mb-4">
        <div>
          <h2 class="text-[18px] md:text-[20px] font-bold text-gray-900 leading-tight">Produk Rekomendasi</h2>
