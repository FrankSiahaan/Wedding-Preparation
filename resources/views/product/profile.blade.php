            ...
            <nav class="flex items-center justify-between h-14">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button
                        ...
                        <span
                            class="absolute -top-1 -right-1 w-4 h-4 bg-pink-600 text-white text-[9px] font-bold rounded-full grid place-items-center">3</span>
                    </button>
    ...
    <main class="container mx-auto px-4 max-w-5xl py-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-gray-600">Kelola informasi profil Anda untuk mengontrol, melindungi dan
                    mengamankan akun</p>
            </div>
                    ...
                    <form class="space-y-4">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-start gap-2">
                            ...
                            <div class="flex-1 flex flex-wrap gap-2">
                                <select
                                    class="px-2 py-1.5 border border-gray-300 rounded text-xs text-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 min-w-[100px]">
                                ...
                                <select
                                    class="px-2 py-1.5 border border-gray-300 rounded text-xs text-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 min-w-[120px]">
