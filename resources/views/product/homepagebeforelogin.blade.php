        ...
        <div class="container mx-auto px-4 max-w-6xl">
            <nav class="flex items-center justify-between h-14">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="#"
                        class="px-3.5 py-1.5 text-sm font-medium text-white bg-pink-600 rounded-full hover:bg-pink-700 transition-colors">Daftar</a>
                </div>
            </nav>
        </div>
    </header>
        ...
        <section class="pt-8 pb-4 bg-white">
            <div class="container mx-auto px-4 max-w-6xl">
                ...
                <div class="grid grid-cols-3 md:grid-cols-5 gap-6">
                    ...
                    <div class="text-center">
                        <div
                            class="w-14 h-14 mx-auto mb-3 bg-purple-100 rounded-full flex items-center justify-center">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="font-semibold text-gray-900 text-sm">Makeover</h3>
                        <p class="text-xs text-gray-500 mt-0.5">120+</p>
                    </div>
